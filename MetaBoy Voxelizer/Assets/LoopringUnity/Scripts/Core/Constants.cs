public static class Constants
{
    ...
    //Login/Unlock States.
    public const int WALLET_DISCONNECT = 0;
    public const int WALLET_CONNECT = 1;
    public const int WALLET_UNLOCK = 2;
    public const int WALLET_READY = 3;
    ...
    public static string[] ipfsLinks;
